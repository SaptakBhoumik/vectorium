//Translated to c++ from https://gist.github.com/alksily/7a85a1898e65c936f861ee93516e397d
#include <stdlib.h>
#include <stdio.h>
#include <cmath>
#include <iostream>
...
namespace Vectorium{
const int p[]={151,160,137,91,90,15,131,13,201,95,96,53,194,233,7,
...
__always_inline double grad(int hash, double x, double y, double z) {
...
double smoothNoise(double x, double y, double z,double seed) {
...
double PerlinNoise(double x, double y, double z,double seed) {
	double value = 0.0;
	double size = 35;
